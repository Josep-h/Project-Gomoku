...
class MuZeroConfig:
    def __init__(self):
        ...
        self.max_moves = 49  # Maximum number of moves if game is not finished before 121 -> 6
        self.num_simulations = 100  # Number of future moves self-simulated  400 -> 20
        ...
        self.blocks = 3  # Number of blocks in the ResNet 6->3
        self.channels = 32  # Number of channels in the ResNet 128->32
        self.reduced_channels_reward = 2  # Number of channels in reward head
        self.reduced_channels_value = 2  # Number of channels in value head
        self.reduced_channels_policy = 4  # Number of channels in policy head
        self.resnet_fc_reward_layers = [16]  # Define the hidden layers in the reward head of the dynamic network 64->16
        ...
        self.save_model = True  # Save the checkpoint in results_path as model.checkpoint
        self.training_steps = 1000  # Total number of training steps (ie weights update according to a batch)50000->1000
        ...
        self.weight_decay = 1e-4  # L2 weights regularization
        self.momentum = 0.9  # Used only if optimizer is SG

        # Exponential learning rate schedule
        self.lr_init = 0.02  # Initial learning rate  0.002->0.02
        ...
        ### Replay Buffer
        self.replay_buffer_size = 100  # Number of self-play games to keep in the replay buffer 10000->100
        self.num_unroll_steps = 49  # Number of game moves to keep for every batch element 121->6
        self.td_steps = 49  # Number of steps in the future to take into account for calculating the target value 121->6
